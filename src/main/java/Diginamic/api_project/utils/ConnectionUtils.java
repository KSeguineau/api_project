package Diginamic.api_project.utils;
...
public class ConnectionUtils {
	...
	public static void doClose() {
		try {
			...
			SERVICE_LOG.error("impossible de fermer la connexion", e);
			throw new TechnicalException("impossible de fermer la connexion", e);
		}
